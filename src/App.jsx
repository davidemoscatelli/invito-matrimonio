...
function App() {
  ...
  return (
    <>
      {/* PLAYER MUSICALE YOUTUBE INVISIBILE */}
      {isMusicPlaying && (
        <iframe
          width="10" height="10"
          src={`https://www.youtube.com/embed/hacc1eHv-6c?autoplay=1&playsinline=1${isMuted ? '&mute=1' : ''}`}
      ...
      {/* COMPONENTE BUSTA (Passiamo le funzioni di apertura e musica) */}
      {!isSiteVisible && (
        <Envelope 
      ...
      {/* TASTO FLUTTUANTE PER LA MUSICA (In basso a destra) */}
      {isSiteVisible && isMusicPlaying && (
        <button 
          ...
          aria-label="Attiva o disattiva musica"
        >
      ...
      {isSiteVisible && (
        ...
        >
          {/* 1. HERO SECTION (Copertina con il NUOVO VIDEO) */}
          <section className="h-[100svh] relative flex flex-col justify-center items-center text-center p-4 overflow-hidden bg-stone-900">
            ...
            >
              {/* IL TUO VIDEO DELLA TAVOLATA IMPERIALE */}
            ...
            <div className="z-20 text-white flex flex-col items-center w-full px-4">
              ...
              <h1 className="font-serif text-6xl md:text-8xl mb-6 italic drop-shadow-lg">Krizia & Davide</h1>
          ...
          <section className="py-16 md:py-20 bg-[#FAF9F6] text-center px-6">
            <div className="max-w-3xl mx-auto flex flex-col items-center">
              ...
              <h2 className="font-serif text-2xl md:text-4xl italic text-stone-700 leading-relaxed md:leading-loose">
          ...
          <section className="py-20 md:py-24 bg-[#ebe6df] px-6 text-center">
            <div className="max-w-xl mx-auto">
               ...
               <p className="text-stone-600 font-light text-sm md:text-base mb-10 leading-relaxed">
          ...
          <section id="rsvp" className="py-20 md:py-32 bg-stone-900 text-white px-6 text-center">
            ...
            <p className="mb-10 md:mb-16 text-stone-400 font-light text-sm md:text-base">Ti preghiamo di confermare la tua presenza entro il 2 Maggio 2026</p>
